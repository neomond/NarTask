...
class CallForwardingView: UIView {
    ...
    private lazy var descriptionLabel: UILabel = {
        let label = UILabel()
        label.text = "Daxil olan zəngləri digər nömrəyə yönləndir. Hesablama cari tarifə uyğun aparılacaq. Zənglərin yönləndirilməsi aktivdirsə. Buraxılmış zəng xidməti çalışmır."
